    ...
    inputSchema: {
      ...
      properties: {
        url: {
          type: "string",
          description:
            "URL of the tab to capture (will switch to this tab automatically)",
        },
      },
    },
  },
    ...
    inputSchema: {
      ...
      properties: {
        url: {
          type: "string",
          description:
            "URL of the tab to get info from (will switch to this tab automatically)",
        },
      },
    },
  },
    ...
    inputSchema: {
      ...
      properties: {
        url: {
          type: "string",
          description:
            "URL of the tab to get source from (will switch to this tab automatically)",
        },
      },
    },
  },
      ...
      case "capture_viewport": {
        ...
        if (response.success && response.data?.screenshot) {
          ...
          const errorDetails = [
            ...
            response.data && !response.data.screenshot
              ? `Data exists but no screenshot`
              : "",
          ]
            .filter(Boolean)
            .join(" | ");
